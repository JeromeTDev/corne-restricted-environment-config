...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3_ex2(KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_TRNS, KC_TRNS, KC_7, KC_8, KC_9, KC_PSLS, KC_PAST, KC_TRNS, KC_TRNS, KC_CIRC, KC_AMPR, KC_ASTR, KC_PMNS, S(KC_0), KC_TRNS, KC_TRNS, KC_4, KC_5, KC_6, KC_PMNS, KC_PPLS, KC_NO, KC_TRNS, RALT(KC_5), KC_NO, KC_NO, KC_UNDS, KC_PLUS, KC_1, KC_2, KC_3, KC_PDOT, S(KC_0), KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0, KC_PCMM),
