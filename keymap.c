...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(
        QK_GESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_PSCR, KC_VOLU, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, 
        LCTL_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_LALT, KC_VOLD, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, 
        KC_LGUI, LT(1,KC_SPC), KC_ENT, KC_ENT,LT(2,KC_SPC), KC_RALT
    ),
    [1] = LAYOUT_split_3x6_3_ex2(
        KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_TRNS, KC_TRNS, KC_PSLS, KC_7, KC_8, KC_9, KC_PLUS, KC_TRNS, 
        KC_TRNS, KC_CIRC, KC_AMPR, KC_ASTR, KC_PMNS, KC_PEQL, KC_TRNS, KC_TRNS, KC_PAST, KC_4, KC_5, KC_6, KC_UNDS, KC_TRNS, 
        KC_TRNS, RALT(KC_5), KC_NO, KC_NO, KC_UNDS, KC_PLUS, KC_NO, KC_1, KC_2, KC_3, KC_PCMM, KC_PDOT, 
    ...
    [2] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_F10, KC_F11, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_NO, KC_PSCR, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_F12, 
